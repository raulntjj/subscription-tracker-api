...
return [
    /*
    |--------------------------------------------------------------------------
    | Linhas de Idioma de Validação - GLOBAL (Shared Module)
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma contêm as mensagens de erro padrão usadas
    | pela classe validadora do Laravel. Este arquivo serve como fallback global
    | para todos os módulos quando não houver uma tradução específica.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Validações Customizadas do Módulo Shared
    |--------------------------------------------------------------------------
    */

    'custom' => [
        'queue' => [
            'required' => 'O nome da fila é obrigatório.',
            'string' => 'O nome da fila deve ser um texto válido.',
        ],
        'connection' => [
            'required' => 'O nome da conexão é obrigatório.',
            'string' => 'O nome da conexão deve ser um texto válido.',
        ],
        'days' => [
            'required' => 'O número de dias é obrigatório.',
            'integer' => 'Dias deve ser um número inteiro.',
            'min' => 'Dias deve ser pelo menos :min.',
        ],
    ],
