...
final class BillingHistoryTest extends SubscriptionTestCase
{
    ...
    public function test_creates_billing_history_with_all_fields(): void
    {
        $billingHistory = new BillingHistory(
            ...
            amountPaid: Money::fromCents(4990), // R$ 49,90
            paidAt: $this->paidAt,
        ...
        $this->assertEquals(4990, $billingHistory->amountPaid()->toCents());
    ...
    public function test_amount_paid_formatted_returns_correct_float_value(): void
    {
        ...
        $this->assertEquals(49.90, $billingHistory->amountPaid()->toUnits());
    }
    ...
    public function test_amount_paid_formatted_handles_zero(): void
    {
        $billingHistory = new BillingHistory(
            id: $this->id,
            subscriptionId: $this->subscriptionId,
            amountPaid: Money::fromCents(0),
            paidAt: $this->paidAt,
            createdAt: $this->createdAt,
        );

        $this->assertEquals(0.0, $billingHistory->amountPaid()->toUnits());
    }
    ...
    public function test_amount_paid_formatted_handles_large_values(): void
    {
        $billingHistory = new BillingHistory(
            id: $this->id,
            subscriptionId: $this->subscriptionId,
            amountPaid: Money::fromCents(999999), // R$ 9.999,99
            paidAt: $this->paidAt,
            createdAt: $this->createdAt,
        );

        $this->assertEquals(9999.99, $billingHistory->amountPaid()->toUnits());
    }
    ...
    public function test_accepts_zero_amount(): void
    {
        ...
        $this->assertEquals(0, $billingHistory->amountPaid()->toCents());
    }
    ...
    public function test_stores_amount_in_cents(): void
    {
        $billingHistory = new BillingHistory(
            id: $this->id,
            subscriptionId: $this->subscriptionId,
            amountPaid: Money::fromCents(2990), // R$ 29,90
            paidAt: $this->paidAt,
            createdAt: $this->createdAt,
        );

        $this->assertEquals(2990, $billingHistory->amountPaid()->toCents());
        $this->assertEquals(29.90, $billingHistory->amountPaid()->toUnits());
    }
    ...
    public function test_handles_different_subscription_ids(): void
    {
        ...
        $billing1 = new BillingHistory(
            ...
            amountPaid: Money::fromCents(1000),
            paidAt: $this->paidAt,
            createdAt: $this->createdAt,
        );
        ...
        $billing2 = new BillingHistory(
            ...
            amountPaid: Money::fromCents(2000),
            paidAt: $this->paidAt,
            createdAt: $this->createdAt,
        );
    ...
    private function createBillingHistory(
        ...
        return new BillingHistory(
            id: $this->id,
            subscriptionId: $this->subscriptionId,
            amountPaid: Money::fromCents($amountPaid),
